...
namespace Native.Csharp.App.Export
{
	...
	{	
		...
		{	
			...
			Common.AppInfo.UnityContainer.RegisterInstance<CQApi> ("io.github.buger404.intallk", api);	
			// 向容器注册一个 CQLog 实例	
			log = new CQLog (authCode);	
			Common.AppInfo.UnityContainer.RegisterInstance<CQLog> ("io.github.buger404.intallk", log);	
